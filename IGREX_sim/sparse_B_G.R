...
sparsityB <- as.numeric(args[10])
sparsityG <- as.numeric(args[11])
...
write.table(out,file=paste("./results/sparsityB",sparsityB,"_sparsityG",sparsityG,"_SNRy",sb2_true,"_n",n1,"_",n2,".txt",sep=""),quote = F,col.names = T,row.names = F)
